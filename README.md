...
- **Component tag:** `x-2114311-network-chart-uic`
- **Scope:** `x_2114311_network_0`
...
(`src/x-2114311-network-chart-uic/chart.js`), then document the properties and events here.
